        ...
        children: [
          Column(
            ...
            children: [
              ...
              _RichText(value1: "${data.ay} ", value2: "Ay - MesEarth"),
              const SizedBox(height: 3),
              _RichText(value1: "${data.gun} ", value2: "Gün - MesEarth "),
              const SizedBox(height: 3),
              _RichText(value1: "${data.kalanGun} ", value2: "Gün Sonra \nİlk Grafikler Gelecek"),
            ],
          ),
          const Spacer(),
